function chartp(data) {	
	...
	function drawArc(x, y, r, startAngle, endAngle, color, value, desc, extra) {
		...
		arc.on("mouseout", function(){ 
			...
			$("#value-pro span").html("");
			$("#value-namep").html("");
			$("#value-pro").css("background-color", "transparent");
		});
		
		arc.on("mouseover", function(){
			$("#pro-chart .cursor-chart").hide();
			...
			$("#value-namep").html(html);
			$("#value-pro span").html(value);
			$("#value-pro").css("background-color", color);
